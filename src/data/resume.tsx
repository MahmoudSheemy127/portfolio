    ...
    },
{
      ...
      active: true,
      description:
        "A scalable e-commerce platform for buying and selling products, engineered with a robust microservices architecture. The system bridges traditional backend engineering with modern AI, featuring hybrid search (RRF + pgvector) and an NCF-based recommendation engine. It includes an autonomous Gemini-powered agent using Model Context Protocol (MCP) for intelligent inventory and cart management, all secured via stateless JWT/RBAC and a centralized Nginx gateway.",
      technologies: [
        "Java Spring Boot",
        "Python FastAPI",
        "Next.js",
